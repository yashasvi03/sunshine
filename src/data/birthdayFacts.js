// CUSTOMIZE THIS FILE WITH YOUR BIRTHDAY FACTS
export const birthdayFacts = {
  dayOfWeek: "Thursday", // Feb 17, 2000 was a Thursday
  topSong: "I Knew I Loved You",
  topArtist: "Savage Garden",
  ...
  yourMeetingDate: "June 15, 2022" // CUSTOMIZE THIS
};
...
export const facts = [
  {
    id: 1,
    icon: "🌟",
    text: "On Thursday, February 17, 2000, the world got brighter",
    animation: "fadeInUp"
  },
  {
    id: 2,
    icon: "🎵",
    text: "'I Knew I Loved You' by Savage Garden",
